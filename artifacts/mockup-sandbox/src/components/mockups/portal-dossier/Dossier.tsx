        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 px-2.5 py-1 rounded-[2px]" style={{ background: "rgba(255,255,255,0.05)" }}>
              ...
              <span className="font-mono-custom text-[10px] text-[#F5EFE3]">Tenant ontology · Patagonia.brandSocial</span>
            </div>
            ...
            {[
              ...
              },
              {
                ...
                items: [
                  ...
                  { label: "Brand and social", conf: 78, status: "warn", active: true }
                ]
              },
              {
                title: "Operational",
        ...
        <main className="flex-1 overflow-y-auto relative bg-[#F5EFE3]">
          ...
          <div className="relative z-10 max-w-[1200px] mx-auto px-8 py-10">
            ...
            <div className="mb-12 border-b pb-6" style={{ borderColor: "#E8DFC9" }}>
              ...
              <h1 className="font-serif-custom text-5xl text-[#0F1A33] mb-4">Brand and social</h1>
              <p className="font-serif-custom italic text-xl text-[#4A5570]">"What is our brand earning us, and where are we leaking it?"</p>
              ...
              <div className="flex items-center gap-6 mt-6 font-mono-custom text-[11px] text-[#4A5570]">
                ...
                <div className="flex items-center gap-2">Confidence 78% <span className="text-[#D85A30]">Close 3 gaps → 92% confidence</span></div>
                <div>11 sources</div>
              </div>
            </div>
            ...
            <section className="mb-16">
              ...
              <div className="grid grid-cols-4 gap-6 mb-8">
                {[
                  { label: "Earned media value", val: "$42.1M", sub: "+18% YoY", color: "#1D9E75", t: "V" },
                  { label: "Paid spend", val: "$15.0M", sub: "flat", color: "#4A5570", t: "V" },
                  { label: "KPMG CX rank", val: "#3", sub: "+1 spot", color: "#1D9E75", t: "V" },
                  { label: "Loyalty self-ID", val: "80%", sub: "slipping QoQ", color: "#D69A2D", t: "M" }
                ].map((kpi, i) => (
              ...
              <div className="mb-8 p-8 border-y" style={{ background: "#FAF6EC", borderColor: "#D4B466" }}>
                <div className="grid grid-cols-4 gap-6">
                  <div>
                    ...
                    <div className="font-sans font-bold text-[15px]">REI Co-op</div>
                  </div>
                  <div>
                    <div className="font-mono-custom text-[10px] text-[#7A8499] mb-1">Spotlight Competitor</div>
                    <div className="font-sans font-bold text-[15px]">Arc'teryx</div>
                  </div>
                  <div>
                    <div className="font-mono-custom text-[10px] text-[#7A8499] mb-1">Spotlight Segment</div>
                    <div className="font-sans font-bold text-[15px]">Worn Wear cohort</div>
                  </div>
                  <div>
                    <div className="font-mono-custom text-[10px] text-[#7A8499] mb-1">Spotlight Channel</div>
                    <div className="font-sans font-bold text-[15px]">Instagram Reels</div>
                  </div>
                </div>
              </div>
                ...
                <table className="w-full text-left font-mono-custom text-[12px]">
                  <thead>
                    <tr className="border-b" style={{ borderColor: "#E8DFC9" }}>
                      ...
                      <th className="py-3 px-4 text-[#7A8499] font-normal">Earned multiplier</th>
                      <th className="py-3 px-4 text-[#7A8499] font-normal">CX rank</th>
                      <th className="py-3 px-4 text-[#7A8499] font-normal">Loyalty %</th>
                  ...
                  <tbody>
                    <tr className="border-b bg-[#FAF6EC]" style={{ borderColor: "#E8DFC9" }}>
                      ...
                      <td className="py-3 px-4 text-[#1D9E75]">4.2×<span className="provenance-flag">V</span></td>
                      <td className="py-3 px-4 text-[#1D9E75]">#3</td>
                      <td className="py-3 px-4 text-[#D69A2D]">80%</td>
                      <td className="py-3 px-4 text-[#D85A30]">32%</td>
                    </tr>
                    {/* Fake competitors using Patagonia context */}
                    <tr className="border-b" style={{ borderColor: "#E8DFC9" }}>
                      <td className="py-3 px-4">REI Co-op</td>
                      <td className="py-3 px-4">2.1×<span className="provenance-flag modelled">M</span></td>
            ...
            <section className="mb-16">
              ...
              <div className="p-8 border-t-2" style={{ background: "#FFFEFA", borderColor: "#D69A2D" }}>
                ...
                <div className="space-y-6">
                  {[
                    {
                      title: "Worn Wear cannibalisation outpacing new-customer pull-through",
                      impact: "$11.2M",
                      detail: "Resale grew 38% YoY while full-price units fell 6%. Repair customers do not convert to new-buyer cohort."
                    },
                    {
                      title: "Paid media efficiency declining",
                      impact: "$5.8M",
                      detail: "CPM up 22% YoY on Meta. Earned-media campaigns deliver 4.2× engagement at 0.3× CPM."
                    },
                    {
                      title: "Loyalty score masking regional decline",
                      impact: "$11.4M",
                      detail: "National 80% loyalty hides 62% in Sun Belt outlets where Arc'teryx is gaining share."
                    }
                  ].map((cause, i) => (
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="p-6 border" style={{ background: "#FFFEFA", borderColor: "#E8DFC9" }}>
                  ...
                  <ul className="space-y-2 font-mono-custom text-[11px] text-[#4A5570]">
                    ...
                    <li>● KPMG CX panel</li>
                    <li>● Worn Wear POS</li>
                    <li>● Net-A-Porter mention scrape</li>
                    <li>● Sprinklr social listening</li>
                    <li>● Brandwatch</li>
                    <li>● ClimateScope earned-media tracker</li>
                  </ul>
                </div>
                ...
                <div className="p-6 border-t-2" style={{ background: "#FFFEFA", borderColor: "#D85A30" }}>
                  ...
                  <ul className="space-y-4">
                    {[
                      { cat: "DATA", title: "Missing Sun Belt outlet SKU velocity", val: "+5pp" },
                      { cat: "MODEL", title: "Worn Wear LTV attribution broken", val: "+7pp" },
                      { cat: "INTEG", title: "Sprinklr sentiment disconnected from POS", val: "+2pp" }
                    ].map((gap, i) => (
                      <li key={i}>
