      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <nav className="w-[280px] shrink-0 flex bg-[var(--cream-light)] border-r border-[var(--cream-dark)]">
          ...
          <div className="w-[48px] flex flex-col items-center py-4 gap-4 bg-[var(--cream-dark)]/50 border-r border-[var(--cream-dark)]">
            ...
            <button className="h-8 w-8 flex items-center justify-center rounded text-[var(--slate)] hover:bg-[var(--cream)] hover:text-[var(--navy)] transition-colors" title="Market-facing">
              <Megaphone size={16} strokeWidth={2} />
              <span className="absolute top-1.5 right-1.5 h-1.5 w-1.5 rounded-full bg-[var(--amber)]" />
            </button>
            <button className="h-8 w-8 flex items-center justify-center rounded bg-[var(--navy)] text-[var(--gold)] shadow-sm relative" title="Operational">
          ...
          <div className="flex-1 flex flex-col py-4">
            ...
            <ul className="flex-1 space-y-0.5">
              {[
                ...
                { label: "Supply chain", status: "warn", icon: Truck, active: true },
              ].map((item, idx) => (
                <li key={idx}>
          ...
          <div className="max-w-[1400px] mx-auto p-6 lg:p-8 space-y-6">
            ...
            <section className="bg-white border border-[var(--cream-dark)] rounded-lg p-5 flex flex-col xl:flex-row items-center justify-between gap-6 shadow-sm relative overflow-hidden">
              ...
              <div className="flex-1 min-w-0">
                ...
                <h1 className="font-['Crimson_Pro'] text-[32px] md:text-[40px] font-semibold text-[var(--navy)] leading-tight tracking-tight">Supply chain</h1>
                <p className="font-['Crimson_Pro'] italic text-[18px] text-[var(--slate)] mt-1 max-w-2xl leading-snug">"Where is the network bleeding cost or risk we have not priced in?"</p>
              </div>
              ...
              <div className="flex items-center gap-8 shrink-0 bg-[var(--cream-light)] p-4 rounded border border-[var(--cream-dark)]">
                ...
                <div className="flex flex-col items-center">
                  <div className="relative w-20 h-10 overflow-hidden mb-1">
                    <svg viewBox="0 0 100 50" className="w-full h-full overflow-visible">
                      ...
                      <path d="M 10 50 A 40 40 0 0 1 90 50" fill="none" stroke="var(--navy)" strokeWidth="12" strokeLinecap="round" strokeDasharray="125.6" strokeDashoffset="40.192" /* 68% of 125.6 */ />
                    </svg>
                    <div className="absolute bottom-0 left-0 w-full text-center">
                      <span className="font-['JetBrains_Mono'] text-[18px] font-bold text-[var(--navy)]">68<span className="text-[12px]">%</span></span>
                    </div>
                  </div>
                  <div className="text-[10px] text-[var(--slate)] text-center font-medium">Confidence<br/><span className="text-[var(--navy)] font-bold">19 sources</span></div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <span className="font-['JetBrains_Mono'] text-[14px] font-bold text-[var(--teal)]">+$47.2M</span>
                  </div>
                  <div className="flex items-center justify-between gap-4">
                    <span className="text-[11px] font-semibold text-[var(--slate)]">Gaps to close (4)</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              ...
              <div className="lg:col-span-7 space-y-6">
                ...
                <div className="bg-white border border-[var(--cream-dark)] rounded p-5 relative shadow-sm">
                  ...
                  <p className="font-['Crimson_Pro'] text-[17px] leading-relaxed text-[var(--ink)]">
                    Q4 fill-rate is tracking 91% against a 96% plan as the Vietnam-to-Reno corridor absorbs a 14-day delay from the August typhoon system, with $34M in technical-outerwear inventory still in transit. Two tier-2 wool suppliers in Argentina (representing 38% of merino baselayer feedstock) are at code-amber on the Patagonia social-audit programme, exposing a $12M wholesale-cancellation risk. Recycled-fleece input pricing has spiked 22% on PET feedstock contraction and the hedged inventory runs out Jan 10.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {[
                      {
                        title: "Air-freight the top-50 SKUs in transit from Vietnam",
                        impact: "+$18.0M revenue at risk",
                        detail: "$2.1M expedite cost saves $20.1M of Q4 DTC and prevents the wholesale cancellation cascade. Decision window closes in 11 days."
                      },
                      {
                        title: "Stand up parallel Argentine merino source",
                        impact: "+$12.0M risk eliminated",
                        detail: "Two pre-approved tier-2 alternates already inside the audit programme. 14-week qualification covers 60% of exposure by Q1."
                      },
                      {
                        title: "Hedge recycled-fleece input to June",
                        impact: "+$17.2M margin protect",
                        detail: "PET feedstock futures available at 8% below current spot. Lock 80% of forecasted volume."
                      }
                    ].map((act, i) => (
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    { label: "Fill rate", val: "91%", sub: "vs 96% plan", tone: "bad" },
                    { label: "In-transit value", val: "$34M", sub: "+$14M vs plan", tone: "warn" },
                    { label: "Supplier code-ambers", val: "2", sub: "Argentina merino", tone: "bad" },
                    { label: "Hedge runway", val: "87 days", sub: "PET feedstock", tone: "warn" }
                  ].map((kpi, i) => (
                    <div key={i} className="bg-white border border-[var(--cream-dark)] rounded p-3 shadow-sm hover:border-[var(--navy)] transition-all cursor-pointer group">
                      ...
                      <div className={`font-['JetBrains_Mono'] text-[24px] font-bold leading-none my-1.5 ${
                        ...
                        kpi.tone === "warn" ? "text-[var(--amber)]" : 
                        kpi.tone === "bad" ? "text-[var(--red)]" : "text-[var(--navy)]"
                      }`}>
                        {kpi.val}
                      </div>
                ...
                <div className="bg-[var(--navy-deep)] text-white rounded p-5 border border-[var(--gold)]/20 shadow-md">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="bg-white/10 border border-white/20 rounded px-2.5 py-1 text-[11px] flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[var(--coral)]" /> Vietnam-Reno corridor <span className="opacity-50 ml-1">Region</span>
                    </span>
                    <span className="bg-white/10 border border-white/20 rounded px-2.5 py-1 text-[11px] flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[var(--coral)]" /> Argentina merino tier-2 <span className="opacity-50 ml-1">Supplier</span>
                    </span>
                    <span className="bg-white/10 border border-white/20 rounded px-2.5 py-1 text-[11px] flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[var(--teal)]" /> PET feedstock futures <span className="opacity-50 ml-1">Metric</span>
                    </span>
                    <span className="bg-white/10 border border-white/20 rounded px-2.5 py-1 text-[11px] flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[var(--teal)]" /> Air-freight expedite <span className="opacity-50 ml-1">Channel</span>
                    </span>
                  </div>
                </div>
                  ...
                  <table className="w-full text-[11px] text-left">
                    <thead>
                      <tr className="border-b border-[var(--cream-dark)] text-[var(--slate)]">
                        ...
                        <th className="pb-2 font-medium">Fill rate %</th>
                        <th className="pb-2 font-medium">Inv. days</th>
                        <th className="pb-2 font-medium">Audit green %</th>
                        <th className="pb-2 font-medium">Dual-source %</th>
                      </tr>
                    </thead>
                    <tbody className="font-['JetBrains_Mono']">
                      <tr className="bg-[var(--cream-light)] font-bold text-[var(--navy)]">
                        ...
                        <td className="py-2 text-[var(--red)]">91%</td>
                        <td className="py-2 text-[var(--amber)]">112</td>
                        <td className="py-2 text-[var(--amber)]">72%</td>
                        <td className="py-2 px-1 rounded-r">48%</td>
                      </tr>
              ...
              <div className="flex gap-4 overflow-x-auto pb-4 rail-scroll snap-x">
                ...
                <div className="min-w-[320px] max-w-[320px] shrink-0 bg-white border border-[var(--amber)]/40 rounded shadow-sm snap-start flex flex-col">
                  ...
                  <div className="p-4 space-y-4 flex-1">
                    {[
                      { t: "Vietnam corridor disruption from August typhoon system", d: "$18.0M", desc: "14-day delay on technical outerwear, $34M in transit. Wholesale cancellation cascade in 11 days." },
                      { t: "Argentina merino exposure on social-audit programme", d: "$12.0M", desc: "Two tier-2 suppliers code-amber, 38% of feedstock. Wholesale cancel-clause triggered if not resolved." },
                      { t: "PET feedstock hedge runs out mid-January", d: "$17.2M", desc: "Spot up 22% YoY. June-out futures available at 8% below spot." }
                    ].map((cause, i) => (
                ...
                <div className="min-w-[320px] max-w-[320px] shrink-0 bg-white border border-[var(--coral)]/40 rounded shadow-sm snap-start flex flex-col">
                  <div className="p-3 border-b border-[var(--cream-dark)] bg-[var(--coral-faint)] rounded-t">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-[var(--coral)] flex items-center gap-1.5">
                      <CircleSlash size={12}/> Architectural Gaps (4)
                    </span>
                  </div>
                  <div className="p-4 space-y-3 flex-1">
                    {[
                      { c: "DATA", t: "Vessel-tracking AIS lags 12h on Vietnam corridor" },
                      { c: "SIGNAL", t: "Worker-rights audit panel updates quarterly not monthly" },
                      { c: "MODEL", t: "Hedge runway model does not incorporate freight surcharge" },
                      { c: "INTEG", t: "Sourcemap to ERP supplier-master mismatch" }
                    ].map((gap, i) => (
                      <div key={i} className="flex gap-2 items-start">
                        <span className={`shrink-0 text-[9px] font-bold px-1.5 py-0.5 rounded tracking-widest ${
                          ...
                          gap.c === "INTEG" ? "bg-orange-100 text-orange-700" :
                ...
                <div className="min-w-[320px] max-w-[320px] shrink-0 bg-white border border-[var(--cream-dark)] rounded shadow-sm snap-start flex flex-col">
                  ...
                  <div className="p-4 flex-1">
                    <div className="flex flex-wrap gap-1.5">
                      {[
                        "SAP IBP", "Project44 visibility", "Sourcemap audit register",
                        "Bloomberg PET futures", "Vessel-tracking AIS feed", "Customs entry data",
                        "Worker-rights audit panel", "EDI ASNs from top-30 suppliers"
                      ].map((feed, i) => (
