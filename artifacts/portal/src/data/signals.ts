...
export const SIGNAL_POOL: IncomingSignal[] = [
  ...
  { ts: "04:35", source: "Pricing scraper",     layer: "pricing-margin",          metric: "Price index vs Home Depot", text: "Mercer +$20 vs Home Depot on cordless drill range", tone: "warn",  delta: "+$20" },
  { ts: "04:37", source: "Numerator panel",     layer: "competitive-intelligence",metric: "Market share",           text: "Weekly share refresh — Mercer 14.2%, HD 38.9%", tone: "warn",  delta: "−0.1pp" },
...
export const ANOMALIES: Anomaly[] = [
  ...
  { id: "A-2827", ts: "03:42", layer: "competitive-intelligence",severity: "medium",   title: "Lowe's loyalty offer launched",            detail: "Lowe's launched targeted 15% loyalty offer in 6 metros — overlap with Mercer share.", delta: "−0.3pp",evidence: "Field intel + scraper" },
...
GROUP BY channel;`,
  ...
  "competitive-intelligence/Market share": {
    ...
    metric: "Market share",
    value: "14.3%",
    computedAs: "Mercer category sales / Σ(category sales for top-10 competitors)  ·  Q3 2026",
    query:
`SELECT
  brand,
