...
export const LAYERS: LayerData[] = [
  ...
  },
  {
    ...
    analystTake: "73% of the negative-sentiment cluster traces to availability and delivery, this is the supply chain story showing up in the brand layer, and PR has to move in step with operations. Discovery has also bifurcated: classic SEO is eroding on category terms, and the new generative answer engines (ChatGPT, Perplexity, Google AI Overviews, Gemini) cite Home Depot and Lowe's 3, 4× more often than Meridian on the same buyer questions.",
    metrics: [
      { label: "Brand sentiment",          value: "62%",    sub: "down 8pp positive",        tone: "bad"  },
      { label: "Share of voice",           value: "11.8%",  sub: "down 4pp",                 tone: "bad"  },
      { label: "SEO + GEO visibility",     value: "84 / 21%", sub: "rank down 11pts · AI cite 21%", tone: "bad"  },
      { label: "Earned media mentions",    value: "1,247",  sub: "down 19%",                 tone: "warn" },
    ],
    narrative:
      "Brand health softened across every measure that matters in Q3. The headline finding is not the decline itself but its concentration: 73% of the negative sentiment cluster relates to product availability and delivery, not brand affinity. This is the supply chain story showing up in the brand layer. Recovery here lags supply chain recovery by 4–6 weeks based on historic patterns, so investment in PR alongside operational recovery is justified now, not later. Discovery has also fractured along two channels: classic SEO rank slipped from 4.1 to 5.8 on 30 priority terms after Home Depot's CMS revamp, and generative answer engines (ChatGPT, Perplexity, Google AI Overviews, Gemini) cite Meridian on only 21% of high-intent buyer questions versus 68% for Home Depot. GEO is now a distinct discovery channel that needs its own content programme, not an SEO afterthought.",
    causes: [
      ...
      { title: "Low citation share in generative answer engines", impact: "-47pp AI cite share",
        detail: "Across 240 tracked buyer questions on Profound + Otterly, Meridian is cited in 21% of ChatGPT, Perplexity, AI Overviews and Gemini answers vs 68% for Home Depot. Pages lack the structured citations and authoritative entity markup the answer engines reward." },
    ...
    actions: [
      ...
      { title: "GEO content pass for AI answer engines", detail: "Rewrite top 30 category and how-to pages with citable facts, comparison tables, schema.org Product + FAQPage markup, and named-entity reinforcement so ChatGPT, Perplexity, AI Overviews and Gemini cite Meridian alongside Home Depot on buyer questions", impact: "$0.4M" },
      { title: "Targeted paid search in regions",     detail: "Defensive bidding on Meridian Industrial + competitor terms", impact: "$0.2M" },
      { title: "Influencer programme, DIY + Garden",  detail: "12 creators, six-week activation",                impact: "$0.2M" },
    ],
    ...
    gaps: [
      ...
      { category: "SIGNAL", title: "AI answer-engine citation tracking", detail: "No structured view of where Meridian is cited (or absent) across ChatGPT, Perplexity, AI Overviews and Gemini on category buyer questions", confidenceLiftPp: 3, solution: "GEO Pulse, Answer-Engine Tracker" },
    ...
    gapsPipelineUsd: "$1.5M indicative pipeline",
    counterArgs: [
