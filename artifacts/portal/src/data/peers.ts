...
// is meaningful, with Mercer's value alongside sector median and best-in-class.
...
export interface PeerMetric {
  ...
  unit: string;
  // Position on the 0-100 spectrum where Mercer sits relative to peers.
  // 0 = worst, 50 = median, 100 = best-in-class.
  position: number;
  // tone of Mercer's position
...
export const PEERS: Record<string, PeerBlock> = {
  "business-performance": {
    ...
    metrics: [
      { metric: "Revenue growth YoY",  mercer: "−2.1%", median: "+3.4%", best: "+6.8%", bestLabel: "Tractor Supply", unit: "%",
      ...
      { metric: "Operating margin",    mercer: "11.2%", median: "13.8%", best: "16.4%", bestLabel: "Home Depot",     unit: "%",
        position: 28, tone: "behind", comment: "Sector-wide compression visible, but Mercer's 240bps Q3 slip is the deepest." },
      { metric: "Customer NPS",        mercer: "38",    median: "44",    best: "56",    bestLabel: "Ace Hardware",   unit: "pts",
      ...
      { metric: "Inventory turns",     mercer: "4.8×",  median: "5.1×",  best: "6.4×",  bestLabel: "Home Depot",     unit: "×",
  ...
  "demand-intelligence": {
    peerSet: PEER_SET, asOf: AS_OF,
    metrics: [
      { metric: "Forecast accuracy (MAPE)", mercer: "11pp", median: "8pp", best: "5pp", bestLabel: "Home Depot", unit: "pp",
        position: 22, tone: "behind", comment: "Median is the credible near-term target — HD's 5pp reflects 4 years of ML investment." },
      { metric: "Stockout days top-100",     mercer: "41",   median: "22",  best: "12",  bestLabel: "Home Depot", unit: "days",
      ...
      { metric: "Share of category — DIY",   mercer: "11.4%",median: "12.6%",best: "38.9%",bestLabel: "Home Depot", unit: "%",
        position: 42, tone: "behind", comment: "HD is the outlier; median is the live competitive set Mercer is fighting on the ground." },
    ],
  },
  ...
  "pricing-margin": {
    peerSet: PEER_SET, asOf: AS_OF,
    metrics: [
      { metric: "Gross margin — top-50 SKUs", mercer: "18.4%", median: "21.1%", best: "24.6%", bestLabel: "Tractor Supply", unit: "%",
      ...
      { metric: "Price index vs market",       mercer: "+1.4%",  median: "−0.2%", best: "−0.8%", bestLabel: "Lowe's",         unit: "%",
        position: 32, tone: "behind", comment: "Mercer prices slightly above market — fine on premium SKUs, costly on cordless where elasticity is highest." },
      { metric: "Margin pull-through rate",    mercer: "84%",    median: "91%",   best: "96%",   bestLabel: "Home Depot",     unit: "%",
  ...
  "supply-chain": {
    peerSet: PEER_SET, asOf: AS_OF,
    metrics: [
      { metric: "Supplier OTD",         mercer: "78%",  median: "89%",  best: "94%",  bestLabel: "Home Depot", unit: "%",
      ...
      { metric: "Days inventory on-hand",mercer: "62d",  median: "58d",  best: "44d",  bestLabel: "Home Depot", unit: "days",
      ...
      { metric: "Perfect-order rate",   mercer: "86%",  median: "92%",  best: "96%",  bestLabel: "Home Depot", unit: "%",
  ...
  "sales-pipeline": {
    peerSet: PEER_SET, asOf: AS_OF,
    metrics: [
      { metric: "Trade win rate",        mercer: "14%",  median: "19%",  best: "24%",  bestLabel: "Home Depot",  unit: "%",
        position: 22, tone: "behind", comment: "Halved YoY (was 21%). The slip is structural to the pricing-match cycle, not the salesforce." },
      { metric: "Cycle days (trade)",     mercer: "82d",  median: "61d",  best: "48d",  bestLabel: "Ace",         unit: "days",
      ...
      { metric: "Pipeline coverage (Q+1)",mercer: "2.4×", median: "3.0×", best: "3.6×", bestLabel: "Home Depot",  unit: "×",
  ...
  "customer-intelligence": {
    peerSet: PEER_SET, asOf: AS_OF,
    metrics: [
      { metric: "NPS — trade segment",     mercer: "44", median: "48", best: "61", bestLabel: "Ace Hardware", unit: "pts",
      ...
      { metric: "12-month repeat rate",     mercer: "61%", median: "68%", best: "78%", bestLabel: "Home Depot", unit: "%",
        position: 38, tone: "behind", comment: "Concentrated drop in two metros (Phoenix, Atlanta). National rate masks the local issue." },
      { metric: "Service-resolution time",  mercer: "18h", median: "14h", best: "6h",  bestLabel: "Tractor Supply", unit: "h",
  ...
  "marketing-performance": {
    peerSet: PEER_SET, asOf: AS_OF,
    metrics: [
      { metric: "Blended ROAS",        mercer: "3.2×", median: "3.6×", best: "4.4×", bestLabel: "Lowe's",       unit: "×",
        position: 38, tone: "behind", comment: "Brand-heavy mix vs peers' performance bias. Reallocation modelled to close to median." },
      { metric: "Attribution coverage", mercer: "64%",  median: "78%",  best: "92%",  bestLabel: "Home Depot",   unit: "%",
