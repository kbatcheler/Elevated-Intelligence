...
export const FEEDS: Record<string, DataFeed[]> = {
  ...
  "talent-hr": [
    ...
    { source: "Comp benchmarking, sector salary survey",type: "External", cadence: "Annual",      lastSync: "240d ago", completeness: 100, status: "stale" },
  ...
  "people-operations": [
    ...
    { source: "Sector comp benchmarking survey",          type: "External", cadence: "Annual",      lastSync: "240d ago", completeness: 100, status: "stale" },
